...
Used by the paperradar skill to find highly influential and high-quality
...
def title_to_note_filename(title: str) -> str:
    ...
    that wikilinks generated by paperradar correctly resolve to files created
    by paper-analyze.
    """
...
def main():
    ...
    # Use shared resolver: $OBSIDIAN_VAULT_PATH/... → ~/.config/paperradar/config.yaml
    try:
    ...
    parser.add_argument('--config', type=str,
                        ...
                        help='Path to research interests config file (defaults to ~/.config/paperradar/config.yaml or $OBSIDIAN_VAULT_PATH/99_System/Config/research_interests.yaml)')
    ...
    # Save results — atomic write so concurrent /paperradar runs (or
